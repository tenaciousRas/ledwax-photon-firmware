...
The code started out as standard C compiled agaist g++, but it's been refactored for c++.  There are multiple branches.  The "master" branch is considered stable, but it's currently just a stub.  As of the version 0.1, no branch is considered stable.
